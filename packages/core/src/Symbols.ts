export class Symbols {
    ...
    public static readonly Observable_unsubscribe = Symbol("Observable_unsubscribe");

    public static readonly Observable_notify = Symbol("Observable_notify");
    ...
    public static readonly Control_usage = Symbol("Control_usage");

    public static readonly Control_definition = Symbol("Control_definition");

    public static readonly Control_items = Symbol("Control_items");
